...
makes both entry points load the same config. `NVIM_APPNAME` also remaps the
plugin/data dir, so **the data dir is unified too**: `~/.local/share/rehamvim ->
